...
class ListInvoices(Choreography):
    ...
    def __init__(self, temboo_session):
        ...
        """
        Choreography.__init__(self, temboo_session, '/Library/MongoHQ/Invoices/ListInvoices')
    ...
    def _make_result_set(self, result, path):
        return ListInvoicesResultSet(result, path)

    def _make_execution(self, session, exec_id, path):
        return ListInvoicesChoreographyExecution(session, exec_id, path)

class ListInvoicesInputSet(InputSet):
    """
...
class ListInvoicesResultSet(ResultSet):
    """
...
class ListInvoicesChoreographyExecution(ChoreographyExecution):
    
    def _make_result_set(self, response, path):
        return ListInvoicesResultSet(response, path)
