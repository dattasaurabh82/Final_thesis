...
class GetDisk(Choreography):
    ...
    def __init__(self, temboo_session):
        ...
        """
        Choreography.__init__(self, temboo_session, '/Library/Google/ComputeEngine/Disks/GetDisk')
    ...
    def _make_result_set(self, result, path):
        return GetDiskResultSet(result, path)

    def _make_execution(self, session, exec_id, path):
        return GetDiskChoreographyExecution(session, exec_id, path)

class GetDiskInputSet(InputSet):
    """
...
class GetDiskResultSet(ResultSet):
    """
...
class GetDiskChoreographyExecution(ChoreographyExecution):
    
    def _make_result_set(self, response, path):
        return GetDiskResultSet(response, path)
