...
class GetNetwork(Choreography):
    ...
    def __init__(self, temboo_session):
        ...
        """
        Choreography.__init__(self, temboo_session, '/Library/Google/ComputeEngine/Networks/GetNetwork')
    ...
    def _make_result_set(self, result, path):
        return GetNetworkResultSet(result, path)

    def _make_execution(self, session, exec_id, path):
        return GetNetworkChoreographyExecution(session, exec_id, path)

class GetNetworkInputSet(InputSet):
    """
...
class GetNetworkResultSet(ResultSet):
    """
...
class GetNetworkChoreographyExecution(ChoreographyExecution):
    
    def _make_result_set(self, response, path):
        return GetNetworkResultSet(response, path)
