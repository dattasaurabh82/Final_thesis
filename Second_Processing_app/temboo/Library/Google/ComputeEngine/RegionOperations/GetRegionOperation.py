...
class GetRegionOperation(Choreography):
    ...
    def __init__(self, temboo_session):
        ...
        """
        Choreography.__init__(self, temboo_session, '/Library/Google/ComputeEngine/RegionOperations/GetRegionOperation')
    ...
    def _make_result_set(self, result, path):
        return GetRegionOperationResultSet(result, path)

    def _make_execution(self, session, exec_id, path):
        return GetRegionOperationChoreographyExecution(session, exec_id, path)

class GetRegionOperationInputSet(InputSet):
    """
...
class GetRegionOperationResultSet(ResultSet):
    """
...
class GetRegionOperationChoreographyExecution(ChoreographyExecution):
    
    def _make_result_set(self, response, path):
        return GetRegionOperationResultSet(response, path)
