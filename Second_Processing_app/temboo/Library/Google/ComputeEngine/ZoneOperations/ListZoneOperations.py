...
class ListZoneOperations(Choreography):
    ...
    def __init__(self, temboo_session):
        ...
        """
        Choreography.__init__(self, temboo_session, '/Library/Google/ComputeEngine/ZoneOperations/ListZoneOperations')
...
class ListZoneOperationsChoreographyExecution(ChoreographyExecution):
    ...
    def _make_result_set(self, response, path):
        return ListZoneOperationsResultSet(response, path)
