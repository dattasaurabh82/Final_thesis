...
class ListFirewalls(Choreography):
    ...
    def __init__(self, temboo_session):
        ...
        """
        Choreography.__init__(self, temboo_session, '/Library/Google/ComputeEngine/Firewalls/ListFirewalls')
    ...
    def _make_result_set(self, result, path):
        return ListFirewallsResultSet(result, path)

    def _make_execution(self, session, exec_id, path):
        return ListFirewallsChoreographyExecution(session, exec_id, path)

class ListFirewallsInputSet(InputSet):
    """
...
class ListFirewallsResultSet(ResultSet):
    """
...
class ListFirewallsChoreographyExecution(ChoreographyExecution):
    
    def _make_result_set(self, response, path):
        return ListFirewallsResultSet(response, path)
