...
class ListRegions(Choreography):
    ...
    def __init__(self, temboo_session):
        ...
        """
        Choreography.__init__(self, temboo_session, '/Library/Google/ComputeEngine/Regions/ListRegions')
    ...
    def _make_result_set(self, result, path):
        return ListRegionsResultSet(result, path)

    def _make_execution(self, session, exec_id, path):
        return ListRegionsChoreographyExecution(session, exec_id, path)

class ListRegionsInputSet(InputSet):
    """
...
class ListRegionsResultSet(ResultSet):
    """
...
class ListRegionsChoreographyExecution(ChoreographyExecution):
    
    def _make_result_set(self, response, path):
        return ListRegionsResultSet(response, path)
