...
class ListImages(Choreography):
    ...
    def __init__(self, temboo_session):
        ...
        """
        Choreography.__init__(self, temboo_session, '/Library/Google/ComputeEngine/Images/ListImages')
    ...
    def _make_result_set(self, result, path):
        return ListImagesResultSet(result, path)

    def _make_execution(self, session, exec_id, path):
        return ListImagesChoreographyExecution(session, exec_id, path)

class ListImagesInputSet(InputSet):
    """
...
class ListImagesResultSet(ResultSet):
    """
...
class ListImagesChoreographyExecution(ChoreographyExecution):
    
    def _make_result_set(self, response, path):
        return ListImagesResultSet(response, path)
