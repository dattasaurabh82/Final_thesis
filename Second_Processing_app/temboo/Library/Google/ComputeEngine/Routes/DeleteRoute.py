...
class DeleteRoute(Choreography):
    ...
    def __init__(self, temboo_session):
        ...
        """
        Choreography.__init__(self, temboo_session, '/Library/Google/ComputeEngine/Routes/DeleteRoute')
    ...
    def _make_result_set(self, result, path):
        return DeleteRouteResultSet(result, path)

    def _make_execution(self, session, exec_id, path):
        return DeleteRouteChoreographyExecution(session, exec_id, path)

class DeleteRouteInputSet(InputSet):
    """
    ...
    def set_Route(self, value):
        ...
        """
        InputSet._set_input(self, 'Route', value)

class DeleteRouteResultSet(ResultSet):
    """
...
class DeleteRouteChoreographyExecution(ChoreographyExecution):
    
    def _make_result_set(self, response, path):
        return DeleteRouteResultSet(response, path)
