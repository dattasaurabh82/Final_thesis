...
class GetRoute(Choreography):
    ...
    def __init__(self, temboo_session):
        ...
        """
        Choreography.__init__(self, temboo_session, '/Library/Google/ComputeEngine/Routes/GetRoute')
    ...
    def _make_result_set(self, result, path):
        return GetRouteResultSet(result, path)

    def _make_execution(self, session, exec_id, path):
        return GetRouteChoreographyExecution(session, exec_id, path)

class GetRouteInputSet(InputSet):
    """
...
class GetRouteResultSet(ResultSet):
    """
...
class GetRouteChoreographyExecution(ChoreographyExecution):
    
    def _make_result_set(self, response, path):
        return GetRouteResultSet(response, path)
