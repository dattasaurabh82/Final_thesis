...
class GetOrganization(Choreography):
    ...
    def __init__(self, temboo_session):
        ...
        """
        Choreography.__init__(self, temboo_session, '/Library/Zendesk/Organizations/GetOrganization')
    ...
    def _make_result_set(self, result, path):
        return GetOrganizationResultSet(result, path)

    def _make_execution(self, session, exec_id, path):
        return GetOrganizationChoreographyExecution(session, exec_id, path)

class GetOrganizationInputSet(InputSet):
    """
...
class GetOrganizationResultSet(ResultSet):
    """
...
class GetOrganizationChoreographyExecution(ChoreographyExecution):
    
    def _make_result_set(self, response, path):
        return GetOrganizationResultSet(response, path)
