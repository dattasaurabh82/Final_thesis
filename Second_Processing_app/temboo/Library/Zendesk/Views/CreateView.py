...
class CreateView(Choreography):
    ...
    def __init__(self, temboo_session):
        ...
        """
        Choreography.__init__(self, temboo_session, '/Library/Zendesk/Views/CreateView')
...
class CreateViewInputSet(InputSet):
    ...
    def set_AllConditions(self, value):
        ...
        """
        InputSet._set_input(self, 'AllConditions', value)
    def set_AnyConditions(self, value):
        ...
        """
        InputSet._set_input(self, 'AnyConditions', value)
