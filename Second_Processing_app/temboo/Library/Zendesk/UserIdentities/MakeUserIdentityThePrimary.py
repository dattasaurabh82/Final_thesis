...
class MakeUserIdentityThePrimary(Choreography):
    ...
    def __init__(self, temboo_session):
        ...
        """
        Choreography.__init__(self, temboo_session, '/Library/Zendesk/UserIdentities/MakeUserIdentityThePrimary')
    ...
    def _make_result_set(self, result, path):
        return MakeUserIdentityThePrimaryResultSet(result, path)

    def _make_execution(self, session, exec_id, path):
        return MakeUserIdentityThePrimaryChoreographyExecution(session, exec_id, path)

class MakeUserIdentityThePrimaryInputSet(InputSet):
    """
...
class MakeUserIdentityThePrimaryResultSet(ResultSet):
    """
...
class MakeUserIdentityThePrimaryChoreographyExecution(ChoreographyExecution):
    
    def _make_result_set(self, response, path):
        return MakeUserIdentityThePrimaryResultSet(response, path)
