...
class CreateRun(Choreography):
    ...
    def __init__(self, temboo_session):
        ...
        """
        Choreography.__init__(self, temboo_session, '/Library/Facebook/Actions/Fitness/Runs/CreateRun')
    ...
    def _make_result_set(self, result, path):
        return CreateRunResultSet(result, path)

    def _make_execution(self, session, exec_id, path):
        return CreateRunChoreographyExecution(session, exec_id, path)

class CreateRunInputSet(InputSet):
    """
...
class CreateRunResultSet(ResultSet):
    """
...
class CreateRunChoreographyExecution(ChoreographyExecution):
    
    def _make_result_set(self, response, path):
        return CreateRunResultSet(response, path)
