...
class DeleteRun(Choreography):
    ...
    def __init__(self, temboo_session):
        ...
        """
        Choreography.__init__(self, temboo_session, '/Library/Facebook/Actions/Fitness/Runs/DeleteRun')
    ...
    def _make_result_set(self, result, path):
        return DeleteRunResultSet(result, path)

    def _make_execution(self, session, exec_id, path):
        return DeleteRunChoreographyExecution(session, exec_id, path)

class DeleteRunInputSet(InputSet):
    """
...
class DeleteRunResultSet(ResultSet):
    """
...
class DeleteRunChoreographyExecution(ChoreographyExecution):
    
    def _make_result_set(self, response, path):
        return DeleteRunResultSet(response, path)
