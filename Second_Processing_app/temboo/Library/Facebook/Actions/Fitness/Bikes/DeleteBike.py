...
class DeleteBike(Choreography):
    ...
    def __init__(self, temboo_session):
        ...
        """
        Choreography.__init__(self, temboo_session, '/Library/Facebook/Actions/Fitness/Bikes/DeleteBike')
    ...
    def _make_result_set(self, result, path):
        return DeleteBikeResultSet(result, path)

    def _make_execution(self, session, exec_id, path):
        return DeleteBikeChoreographyExecution(session, exec_id, path)

class DeleteBikeInputSet(InputSet):
    """
...
class DeleteBikeResultSet(ResultSet):
    """
...
class DeleteBikeChoreographyExecution(ChoreographyExecution):
    
    def _make_result_set(self, response, path):
        return DeleteBikeResultSet(response, path)
