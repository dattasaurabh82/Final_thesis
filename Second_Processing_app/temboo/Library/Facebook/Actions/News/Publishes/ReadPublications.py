...
class ReadPublications(Choreography):
    ...
    def __init__(self, temboo_session):
        ...
        """
        Choreography.__init__(self, temboo_session, '/Library/Facebook/Actions/News/Publishes/ReadPublications')
    ...
    def _make_result_set(self, result, path):
        return ReadPublicationsResultSet(result, path)

    def _make_execution(self, session, exec_id, path):
        return ReadPublicationsChoreographyExecution(session, exec_id, path)

class ReadPublicationsInputSet(InputSet):
    """
...
class ReadPublicationsResultSet(ResultSet):
    """
...
class ReadPublicationsChoreographyExecution(ChoreographyExecution):
    
    def _make_result_set(self, response, path):
        return ReadPublicationsResultSet(response, path)
