...
class DeleteFollow(Choreography):
    ...
    def __init__(self, temboo_session):
        ...
        """
        Choreography.__init__(self, temboo_session, '/Library/Facebook/Actions/General/Follows/DeleteFollow')
    ...
    def _make_result_set(self, result, path):
        return DeleteFollowResultSet(result, path)

    def _make_execution(self, session, exec_id, path):
        return DeleteFollowChoreographyExecution(session, exec_id, path)

class DeleteFollowInputSet(InputSet):
    """
...
class DeleteFollowResultSet(ResultSet):
    """
...
class DeleteFollowChoreographyExecution(ChoreographyExecution):
    
    def _make_result_set(self, response, path):
        return DeleteFollowResultSet(response, path)
