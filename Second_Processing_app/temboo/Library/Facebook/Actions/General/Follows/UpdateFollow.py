...
class UpdateFollow(Choreography):
    ...
    def __init__(self, temboo_session):
        ...
        """
        Choreography.__init__(self, temboo_session, '/Library/Facebook/Actions/General/Follows/UpdateFollow')
    ...
    def _make_result_set(self, result, path):
        return UpdateFollowResultSet(result, path)

    def _make_execution(self, session, exec_id, path):
        return UpdateFollowChoreographyExecution(session, exec_id, path)

class UpdateFollowInputSet(InputSet):
    """
...
class UpdateFollowResultSet(ResultSet):
    """
...
class UpdateFollowChoreographyExecution(ChoreographyExecution):
    
    def _make_result_set(self, response, path):
        return UpdateFollowResultSet(response, path)
