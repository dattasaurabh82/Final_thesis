...
class DeleteQuote(Choreography):
    ...
    def __init__(self, temboo_session):
        ...
        """
        Choreography.__init__(self, temboo_session, '/Library/Facebook/Actions/Books/Quotes/DeleteQuote')
    ...
    def _make_result_set(self, result, path):
        return DeleteQuoteResultSet(result, path)

    def _make_execution(self, session, exec_id, path):
        return DeleteQuoteChoreographyExecution(session, exec_id, path)

class DeleteQuoteInputSet(InputSet):
    """
...
class DeleteQuoteResultSet(ResultSet):
    """
...
class DeleteQuoteChoreographyExecution(ChoreographyExecution):
    
    def _make_result_set(self, response, path):
        return DeleteQuoteResultSet(response, path)
