...
class CreateBasicListing(Choreography):
    ...
    def __init__(self, temboo_session):
        ...
        """
        Choreography.__init__(self, temboo_session, '/Library/eBay/Trading/CreateBasicListing')
    ...
    def _make_result_set(self, result, path):
        return CreateBasicListingResultSet(result, path)

    def _make_execution(self, session, exec_id, path):
        return CreateBasicListingChoreographyExecution(session, exec_id, path)

class CreateBasicListingInputSet(InputSet):
    """
...
class CreateBasicListingResultSet(ResultSet):
    """
...
class CreateBasicListingChoreographyExecution(ChoreographyExecution):
    
    def _make_result_set(self, response, path):
        return CreateBasicListingResultSet(response, path)
