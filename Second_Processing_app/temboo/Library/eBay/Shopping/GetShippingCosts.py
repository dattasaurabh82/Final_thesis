...
class GetShippingCosts(Choreography):
    ...
    def __init__(self, temboo_session):
        ...
        """
        Choreography.__init__(self, temboo_session, '/Library/eBay/Shopping/GetShippingCosts')
...
class GetShippingCostsInputSet(InputSet):
    ...
    def set_IncludeDetails(self, value):
        ...
        """
        InputSet._set_input(self, 'IncludeDetails', value)
    ...
    def set_QuantitySold(self, value):
        ...
        """
        InputSet._set_input(self, 'QuantitySold', value)
