...
class DescribeRegions(Choreography):
    ...
    def __init__(self, temboo_session):
        ...
        """
        Choreography.__init__(self, temboo_session, '/Library/Amazon/EC2/DescribeRegions')
    ...
    def _make_result_set(self, result, path):
        return DescribeRegionsResultSet(result, path)

    def _make_execution(self, session, exec_id, path):
        return DescribeRegionsChoreographyExecution(session, exec_id, path)

class DescribeRegionsInputSet(InputSet):
    """
...
class DescribeRegionsResultSet(ResultSet):
    """
...
class DescribeRegionsChoreographyExecution(ChoreographyExecution):
    
    def _make_result_set(self, response, path):
        return DescribeRegionsResultSet(response, path)
