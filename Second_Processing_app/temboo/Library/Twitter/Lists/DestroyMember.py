...
class DestroyMember(Choreography):
    ...
    def __init__(self, temboo_session):
        ...
        """
        Choreography.__init__(self, temboo_session, '/Library/Twitter/Lists/DestroyMember')
    ...
    def _make_result_set(self, result, path):
        return DestroyMemberResultSet(result, path)

    def _make_execution(self, session, exec_id, path):
        return DestroyMemberChoreographyExecution(session, exec_id, path)

class DestroyMemberInputSet(InputSet):
    """
...
class DestroyMemberResultSet(ResultSet):
    """
...
class DestroyMemberChoreographyExecution(ChoreographyExecution):
    
    def _make_result_set(self, response, path):
        return DestroyMemberResultSet(response, path)
